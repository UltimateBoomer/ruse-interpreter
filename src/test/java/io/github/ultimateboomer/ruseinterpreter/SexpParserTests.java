...
public class SexpParserTests {
    ...
    public void testParse() {
        ...
        assertEquals(new SList(Arrays.asList(new Atom("a"), 
            new SList(Arrays.asList(new Atom("b"), new Atom("c"))))), 
            SExpParser.parse("(a (b c))"));
    }
    ...
    public void testToString() {
        ...
        assertEquals("(a (b c))",
            new SList(Arrays.asList(new Atom("a"), 
                new SList(Arrays.asList(new Atom("b"), new Atom("c"))))).toString());
    }
